...
echo "<a href='delete_pins.php?pin_id=$pid&pic_id=$pic_id&parent_id=$parent_id&board_id=$board_id&board_name=$board_name'><img src='../images/trash2.png' width='14' height='14'/></a>";
if($source==="(NULL)") {
//echo $source;
...
//echo $source;
echo "<div style='margin-bottom:5px;'><a href='$source'><img src='../images/$img_path' class='pin_image' /></a></div>";
}
